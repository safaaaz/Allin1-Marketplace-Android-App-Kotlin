...
class ownersignup : AppCompatActivity() {
    ...
    fun addprod(view: View){
        ...
        FirebaseDatabase.getInstance("https://allin1-23085-default-rtdb.asia-southeast1.firebasedatabase.app").reference.child(FirebaseAuth.getInstance().currentUser!!.uid+"/products").child(name1.text.toString()).setValue(product(
